...
const technicalCategories: TechnicalCategory[] = [
  {
    ...
    subtitle: "Enterprise Wireless Optical Connectivity",
    icon: Radio,
    subcategories: [
      {
        title: "Point-to-Point Wireless Optical Engineering",
        points: [
          "FSO Strategy & Feasibility — Evaluating line-of-sight path geometry, distance parameters, atmospheric attenuation, and total cost of ownership for wireless optical deployment.",
          "Network Integration & Deployment — Designing redundant point-to-point optical architectures, aligning transceiver heads, and connecting FSO with enterprise switch fabrics.",
          "Performance Monitoring & Lifecycle Advisory — Continuous tracking of link health, signal quality, availability SLAs, and proactive maintenance optimization.",
        ],
      },
    ],
  },
