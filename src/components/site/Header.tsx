...
const solutionsCategories = [
  {
    ...
    cta: { text: "Evaluate FSO for your enterprise?", buttonText: "Talk to Expert", href: "/solutions/free-space-optics#fso-form" },
    items: [
      { label: "FSO Strategy & Advisory", href: "/solutions/free-space-optics", subtext: "Feasibility and technology roadmap" },
      { label: "FSO Site Survey & Feasibility", href: "/solutions/free-space-optics", subtext: "Line-of-sight & environmental survey" },
      { label: "FSO Network Design", href: "/solutions/free-space-optics", subtext: "Point-to-point & redundant design" },
      { label: "FSO Deployment & Integration", href: "/solutions/free-space-optics", subtext: "Installation & optical alignment" },
      { label: "FSO Performance Monitoring", href: "/solutions/free-space-optics", subtext: "Link health & SLA tracking" },
    ],
  },
  {
    title: "GPU Optimization",
